...
# Set screen saver idle timeout to 3 minutes (180s)
...
# Display individual mails in a thread in ascending order (Newest at the bottom)
...
defaults write org.vim.MacVim MMAutosaveColumns 228
defaults write org.vim.MacVim MMAutosaveRows 64
...
defaults write org.mozilla.crashreporter submitReport -bool false
