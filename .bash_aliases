...
alias update='sudo softwareupdate -i -a; brew update; brew upgrade; brew cleanup; nvm use stable; npm update npm -g; npm update -g; sudo gem update --system; sudo gem update'
